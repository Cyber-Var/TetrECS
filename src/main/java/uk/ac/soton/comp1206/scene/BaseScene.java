...
public abstract class BaseScene {
    ...
    /**
     * The single window to display
     */
    protected final GameWindow gameWindow;

    /**
     * The pane which will scale anything inside it to the screen and maintain the aspect ratio
     */
    protected GamePane root;

    /**
     * The physical contents of the application
     */
